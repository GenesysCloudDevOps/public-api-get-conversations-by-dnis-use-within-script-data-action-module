A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Conversations by DNIS
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-conversations-by-dnis-use-within-script-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Conversations by DNIS"
